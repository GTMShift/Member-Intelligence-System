-- 034_add_country_filter.sql
--
-- Adds a country filter to search_members. Adding a new trailing parameter
-- with a default is one of the few function changes CREATE OR REPLACE can
-- handle directly, unlike changing return columns (which needed an explicit
-- DROP FUNCTION in earlier migrations).
